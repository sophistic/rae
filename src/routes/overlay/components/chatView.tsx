      ...
      <div className="flex-1 flex flex-col overflow-hidden text-foreground bg-black/10 backdrop-blur-md min-h-[300px] relative transition-all duration-200 z-[10] border border-white/20 rounded-xl">
        ...
        <header className="h-[44px] border-b overflow-hidden border-b-white/30 bg-black/15 backdrop-blur-lg w-full flex shadow-sm">
          <div className="h-full w-full flex justify-between items-center px-4 py-2 tracking-tight font-medium">
            <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {titleLoading ? (
                  ...
                  >
                    <Loader2
                      ...
                      aria-hidden="true"
                    />
                    <span className="truncate" id="chat-title">
                      Generating title...
                    </span>
                  </div>
                ) : (
                  <h2 className="truncate flex-1" id="chat-title">
                    {overlayChatTitle}
                  </h2>
                )}
              </div>
              ...
              <AnimatePresence>
                {currResponse && currResponse.trim() && (
                  ...
                  >
                    <motion.div className="absolute inset-0 bg-gradient-to-br from-white/40 to-white/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg blur-[3px]" />
            ...
            <time
              className="text-white/70 text-sm font-light shrink-0 ml-4 bg-black/15 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/20"
          ...
          <nav
            className="h-full flex ml-auto shrink-0"
          ...
          >
            <motion.button
              ...
              title="New Chat"
            >
              <motion.div className="absolute inset-0 bg-gradient-to-br from-[#ff928c]/20 to-[#ff6b6b]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg blur-[2px]" />
        ...
        <section className="relative" aria-label="Message input" role="region">
          ...
          <AnimatePresence>
            {isInputTyping && chatInputText.trim() && (
              ...
              >
                ...
                >
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-blue-300/30 to-blue-400/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full blur-[4px] scale-110" />
                  <motion.div className="relative z-10">
                    <Globe size={16} />
                  </motion.div>
                </motion.button>
                ...
                >
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-purple-300/30 to-purple-400/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full blur-[4px] scale-110" />
                  <motion.div className="relative z-10">
                    <Brain size={16} />
                  </motion.div>
                </motion.button>
          ...
          <div className="h-[44px] focus-within:bg-black/25 text-foreground bg-black/20 backdrop-blur-lg border-t border-white/30 relative flex items-center shrink-0 shadow-md">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                aria-describedby={
                  attachedImage ? "image-attachment" : undefined
                }
                aria-invalid={false}
                maxLength={2000}
                spellCheck={false}
            ...
            <div className="h-full w-fit right-0 inset-y-0 flex items-center">
              ...
              >
                {chatInputText.trim() && (
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-[#ff928c]/30 to-[#ff6b6b]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg blur-[3px]" />
                )}
                <motion.div className="relative z-10">
